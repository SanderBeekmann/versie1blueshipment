...
function GallerySection() {
  ...
  const slides = [
    { 
      ...
      title: "99,7% correct & op tijd verzonden",
      description: "Door het gebruik van efficiënte en goed ingerichte verzendsystemen hebben wij een zeer lage foutmarge",
    ...
    { 
      ...
      description: "Door ons hoge verzendvolume hebben wij gunstige verzendcontracten afgesloten met DHL, PostNL, bpost en DPD, waarvan jij direct profiteert",
    ...
    { 
      ...
      title: "70% tijdsbesparing door automatisering",
      description: "Jij hoeft je alleen nog maar zorgen te maken over de groei van jouw onderneming. Laat de klantvragen, bestellingen & retouren volledig aan ons over.",
